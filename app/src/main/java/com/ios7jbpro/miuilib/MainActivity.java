...
public class MainActivity extends AppCompatActivity {
	...
	public void _language () {
		if (languagetext.getText().toString().equals("English")) {
			...
			textview127.setText("Name says it");
			textview128.setText("Name says it");
			textview129.setText("Watch what apps did");
			textview130.setText("Xiaomi Cloud");
			textview131.setText("For screen");
		}
